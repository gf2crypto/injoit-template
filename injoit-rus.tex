...
\documentclass[journal]{styles/INJOITrus}
...
\bibliographystyle{styles/gost2008}
\input{styles/gost_legacy.tex}
...
\end{IEEEkeywords}
\nocite{*}
\bibliographystyleeng{styles/gost2008}
\nociteeng{*}
\bibliographyeng{bib/refs_en}
\end{otherlanguage}
\end{document}
