...
\addbibresource{
{%- endraw -%}
{{cookiecutter.project_name}}_ru.bib
{%- raw -%}
}
\addbibresource{
{%- endraw -%}
 {{cookiecutter.project_name}}_en.bib
{%- raw -%}
}
...
\DeclareSourcemap{
  \maps[datatype=bibtex]{
    \map{
      \perdatasource{{{cookiecutter.project_name}}_ru.bib}
      \step[fieldset=keywords, fieldvalue={, RU}, append]
    }
    \map{
      \perdatasource{{{cookiecutter.project_name}}_en.bib}
